...
public class Controller {
	...
	public static void executeQueryThree(String prefix, String date) {
		try {
			...
			String query = "SELECT DISTINCT flight_id, boarding_gate, airline, flight_date, "
					+ "boarding_time, departing_time, duration, route " + "FROM " + prefix + ".Flight "
			...
			if (answer != null) {
				...
				while (answer.next()) {
					System.out.println(answer.getString(1) + "\t" + answer.getString(2) + "\t" + answer.getString(3)
							+ "\t" + answer.getString(4) + "\t" + answer.getString(5) + "\t" + answer.getString(6)
	...
	public void insertFlight(int flightId, String airlineName, String boardingGate, java.sql.Date flightDate,
	...
	public void updateFlight(int flightId, String airlineName, String boardingGate, java.sql.Date flightDate,
			LocalTime boardingTime, LocalTime departingTime, int intervalMinutes, int airportFrom, int airportTo)
			throws SQLException {
